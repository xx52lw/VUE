    ...
    <div>
     ...
     <!--   卡片   -->
      <el-card>
        <el-row :gutter="20">
          <el-col :span="8">
            <el-input placeholder="请输入内容" v-model="queryInfo.query" :clearable = "true" @keyup.enter.native="enterClick(2)">
        ...
        <el-table :data="userList" border :stripe="true">
          ...
          <el-table-column label="操作" width="180px" fixed="right">
            ...
            <template slot-scope="scop">
              <el-button type="primary" icon="el-icon-edit" size="mini" @click="editBtnClick(scop.row)"></el-button>
              <el-button type="danger" icon="el-icon-delete" size="mini" @click="deleteBtnClick(scop.row.id)"></el-button>
              <el-tooltip effect="dark" content="分配角色" placement="top" :enterable="false">
                <el-button type="warning" icon="el-icon-setting" size="mini" @click="roleBtnClick(scop.row)"></el-button>
              </el-tooltip>
            </template>
          </el-table-column>
        </el-table>
...
<!--    对话框  -->
       ...
       <!--   内容主题区域     -->
        <el-form :model="addForm" :rules="addFormRules" ref="addFormRef" label-width="70px">
          ...
          <el-form-item label="密码" prop="password">
            <el-input v-model="addForm.password" maxlength="15" type="password"></el-input>
          </el-form-item>
      ...
      <!--   修改用户信息   -->
      <el-dialog title="修改信息" :visible.sync="editeDialogVisible" width="50%" :before-close="editeHandleClose">
        <el-form :model="editForm" :rules="editFormRules" ref="editFormRef" label-width="70px">
          <el-form-item label="用户名" prop="username">
            <el-input v-model="editForm.username" :disabled="true"></el-input>
          </el-form-item>
          <el-form-item label="邮箱" prop="email">
            <el-input v-model="editForm.email" maxlength="30"></el-input>
          </el-form-item>
          <el-form-item label="手机" prop="mobile">
        ...
        <span slot="footer" class="dialog-footer">
          ...
          <el-button type="primary" @click="editeUserRequest">确 定</el-button>
        </span>
      </el-dialog>
      <el-dialog title="分配角色" :visible.sync="roleDialogVisible" width="50%" ::before-close="roleDialogHandleClose">
        <div>
        ...
        <span slot="footer" class="dialog-footer">
          ...
          <el-button type="primary" @click="roleDialogRequest">确 定</el-button>
        </span>
      </el-dialog>
    </div>
</template>
